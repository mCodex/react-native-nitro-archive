import type { ArchiveBufferSource, ArchiveFileSource, ArchiveUriSource } from './types/archive'
...
export function bufferSource(data: ArrayBuffer, name?: string): ArchiveBufferSource {
